...
export type NationalTeamCampaign = { id_campagne: string; id_equipe_nationale: string; nom_campagne: string; date_debut: string; date_fin: string; objectif: string; id_statut_campagne: string; observation: string }
export type CampaignReferences = { statuses: ReferenceOption[]; seasons?: (ReferenceOption & { dateStart: string; dateEnd: string })[] }
...
export type NationalTeamReferences = { federations: ReferenceOption[]; sports: ReferenceOption[]; disciplines: ReferenceOption[]; ageCategories: ReferenceOption[]; sexes: ReferenceOption[]; seasons?:(ReferenceOption&{dateStart:string;dateEnd:string})[]; roles: ReferenceOption[]; ageCategoriesAvailable: boolean; rolesReferentialAvailable: boolean }
