...
import { getCampaignSelections, getMemberActorLabels, getNationalTeam, getNationalTeamCampaigns, getNationalTeamMembers, getNationalTeamReferences, getSelectionReferences } from "@/lib/equipes-nationales/data"
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [refs, campaigns, selections, selectionRefs, members, competitions, programs, engagements, documents] = await Promise.allSettled([
    getNationalTeamReferences(), getNationalTeamCampaigns(id, { fresh: true }), getCampaignSelections(id), getSelectionReferences(), getNationalTeamMembers(id, undefined, undefined, { fresh: true }), getCompetitions(), getCompetitionPrograms(), getCampaignEngagements({ teamId: id }),
