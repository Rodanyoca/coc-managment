...
export type CoachListItem = { id: string; idNational: string; idFederal: string; nomComplet: string; sexe: string; dateNaissance: string; federation: string; federationId: string; statut: string; avatar: string | null }
