...
const refCounts = { TYPES_COMPETITION: 6, NIVEAUX_COMPETITION: 4, STATUTS_COMPETITION: 5, STATUTS_PARTICIPATION_ATHLETE: 5, STATUTS_SELECTION: 5, STATUTS_ENGAGEMENT_PROGRAMME: 5, STATUTS_VALIDATION_RESULTAT: 7, FORMATS_PARTICIPATION: 4, UNITES_MESURE: 7, TYPES_RESULTAT: 8, RESULTATS_SYNTHETIQUES: 8, TYPES_SEGMENTS_RESULTATS: 5, DECISIONS_RESULTATS: 5, ROLES_STAFF_EQUIPE_NATIONALE: 6, DISTINCTIONS_SPORTIVES: 0 }
